...
opt_codes_txt = 'opt_codes.txt'
opt_codes_p = 'optCodes.p'
data_csv = 'data.csv'
final_data_csv = 'final_data.csv'
final_selected_features_txt = 'final_selected_features.txt'
...
VULNERABILITY = (
    ...
    'HACKER_KEYSTORE_LOCATION2',
    'HACKER_KEYSTORE_NO_PWD',
    'HACKER_KEYSTORE_SSL_PINNING',
    'HACKER_KEYSTORE_SSL_PINNING2',
    ...
    'PERMISSION_PROVIDER_EXPLICIT_EXPORTED',
