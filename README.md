...
python2.7,  scikit-learn, androguard1.5,androbugs
...
2. create_tioe.py: This file do TIOE algorithmon on the above generated two files , the purpose of the opcode for dimensionality reduction preprocessing.
